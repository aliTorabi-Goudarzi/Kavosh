package ir.dekot.kavosh.data.model.settings
...
enum class PredefinedColorTheme(
    ...
    BLUE(
        id = "blue",
        nameResId = ir.dekot.kavosh.R.string.color_theme_blue,
        primaryColor = Color(0xFF2196F3),
        secondaryColor = Color(0xFF03DAC6)
    ),
    GREEN(
        id = "green", 
        nameResId = ir.dekot.kavosh.R.string.color_theme_green,
        primaryColor = Color(0xFF4CAF50),
        secondaryColor = Color(0xFF8BC34A)
    ),
    RED(
        id = "red",
        nameResId = ir.dekot.kavosh.R.string.color_theme_red,
        primaryColor = Color(0xFFF44336),
        secondaryColor = Color(0xFFFF5722)
    ),
    PURPLE(
        id = "purple",
        nameResId = ir.dekot.kavosh.R.string.color_theme_purple,
        primaryColor = Color(0xFF9C27B0),
        secondaryColor = Color(0xFF673AB7)
    ),
    ORANGE(
        id = "orange",
        nameResId = ir.dekot.kavosh.R.string.color_theme_orange,
        primaryColor = Color(0xFFFF9800),
        secondaryColor = Color(0xFFFF5722)
    ),
    TEAL(
        id = "teal",
        nameResId = ir.dekot.kavosh.R.string.color_theme_teal,
        primaryColor = Color(0xFF009688),
        secondaryColor = Color(0xFF00BCD4)
    ),
    INDIGO(
        id = "indigo",
        nameResId = ir.dekot.kavosh.R.string.color_theme_indigo,
        primaryColor = Color(0xFF3F51B5),
        secondaryColor = Color(0xFF2196F3)
    ),
    PINK(
        id = "pink",
        nameResId = ir.dekot.kavosh.R.string.color_theme_pink,
...
data class CustomColorTheme(
    ...
    fun toColorTheme(): ColorTheme {
        return ColorTheme(
            id = "custom",
            nameResId = ir.dekot.kavosh.R.string.color_theme_custom,
            primaryColor = primaryColor,
            secondaryColor = secondaryColor,
            isCustom = true
        )

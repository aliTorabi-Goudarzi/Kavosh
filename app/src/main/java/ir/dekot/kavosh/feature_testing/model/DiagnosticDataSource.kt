...
class DiagnosticDataSource @Inject constructor(
    ...
    private fun getCurrentDeviceProfile(): DeviceProfile {
        return DeviceProfile(
            ...
            performanceScore = Random.Default.nextInt(70, 95),
    ...
    private fun getSimilarDevices(): List<DeviceProfile> {
        ...
        return listOf(
            DeviceProfile(
                ...
                performanceScore = Random.Default.nextInt(85, 95)
            ),
            DeviceProfile(
                ...
                performanceScore = Random.Default.nextInt(88, 98)
            )
        )
    }
    ...
    private fun performComparison(current: DeviceProfile, others: List<DeviceProfile>): List<ComparisonResult> {
        ...
        results.add(
            ComparisonResult(
                ...
                ranking = cpuScores.sortedDescending()
                    .indexOf(current.specifications.cpu.maxFrequency) + 1,
        ...
        results.add(
            ComparisonResult(
                ...
                ranking = ramSizes.sortedDescending()
                    .indexOf(current.specifications.ram.totalSize.toDouble()) + 1,
                totalDevices = allDevices.size,
                unit = "MB",

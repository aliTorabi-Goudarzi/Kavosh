...
fun InfoSelectionDialog(
    ...
    title: String, // پارامتر جدید برای عنوان
    confirmButtonText: String, // پارامتر جدید برای متن دکمه تایید
        ...
        CompositionLocalProvider(LocalLayoutDirection provides LayoutDirection.Rtl) {
            Card(
                ...
                Column(modifier = Modifier.padding(16.dp)) {
                    Text(
                        text = title, // استفاده از عنوان داینامیک
                    ...
                    Row(
                        ...
                        TextButton(
                            ...
                            Text(confirmButtonText) // استفاده از متن دکمه داینامیک
                        }
                    }
                }
            }

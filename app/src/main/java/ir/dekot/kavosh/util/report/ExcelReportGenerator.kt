...
object ExcelReportGenerator {
    ...
    private fun createHeader(
        ...
        titleCell.setCellValue("📱 گزارش کامل دستگاه - ${android.os.Build.MANUFACTURER} ${android.os.Build.MODEL}")
    ...
    private fun createDeviceOverview(
        ...
        val overviewData = listOf(
            "برند" to android.os.Build.MANUFACTURER,
            "مدل" to android.os.Build.MODEL,
